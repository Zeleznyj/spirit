...
void Parameters_LLG_Set_Output_Energy( State *state, bool energy_step, bool energy_archive, bool energy_spin_resolved,
...
void Parameters_LLG_Set_Output_Configuration( State *state, bool configuration_step,  bool configuration_archive,
...
void Parameters_LLG_Set_Temperature_Gradient(State *state, float inclination, const float direction[3], int idx_image, int idx_chain) noexcept
{
    try
    {
        std::shared_ptr<Data::Spin_System> image;
...
void Parameters_LLG_Get_Output_Energy( State *state, bool * energy_step, bool * energy_archive,
...
void Parameters_LLG_Get_Temperature_Gradient(State *state, float * inclination, float direction[3], int idx_image, int idx_chain) noexcept
{
    try
    {
        std::shared_ptr<Data::Spin_System> image;
