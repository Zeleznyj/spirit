...
void Parameters_GNEB_Set_Output_Energies( State *state, bool energies_step, bool energies_interpolated, bool energies_divide_by_nos,
...
void Parameters_GNEB_Set_Path_Shortening_Constant(State *state, float path_shortening_constant, int idx_chain) noexcept
try
{
    int idx_image=-1;
    std::shared_ptr<Data::Spin_System> image;
...
void Parameters_GNEB_Get_Output_Energies( State *state, bool * energies_step,
...
void Parameters_GNEB_Get_N_Iterations( State *state, int * iterations, int * iterations_log,
                                       int idx_chain ) noexcept
try
{
    int idx_image = -1;
